...
var MechanicalObject = require('../models/mechanical_object.js').MechanicalObject;
var mechanical_object_map = require('../maps/mechanical_object_map.js').mechanical_object_map;

describe('MechanicalObject',function(){
	describe('#constructor',function() {
		it('should create a new mechanical object base on the map and the source',function() {
			var source = {x:1000,y:2000}
			var mechanical_object = new MechanicalObject(mechanical_object_map,source);
			mechanical_object.map.should.equal(mechanical_object_map);
			mechanical_object.x.should.equal(source.x);
			mechanical_object.y.should.equal(source.y);
			expect(mechanical_object.name).to.be.undefined;
		});
	});
	describe('#set',function() {
		it('should set the values of the celstial object base on the source',function(){
			var initial_source = {x:12,y:13}
			var source = {x:50,y:60}
			var mechanical_object = new MechanicalObject(mechanical_object_map,initial_source);
			mechanical_object.set(source);
